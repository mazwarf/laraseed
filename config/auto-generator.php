...
/**
 * Configuration for azwar/laravel-auto-generator
 *
 * Publish this file to your application with:
 *   php artisan vendor:publish --tag=auto-generator-config
 */
return [
    ...
    */
    ...
    |   php artisan vendor:publish --tag=auto-generator-stubs
    | to get a copy of the built-in stubs you can edit.
    |
    */
    'stubs_path' => null, // e.g. base_path('stubs/auto-generator')
